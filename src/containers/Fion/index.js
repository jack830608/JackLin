...
export default () => {
    ...
    const card1 = (
        ...
        >
            <div
                className="card_fion"
                style={{ background: zIndex === 1 ? 'rgba(0, 0, 0, 0.6)' : 'rgba(255, 255, 255, 0.6)' }}
            >
    ...
    const card2 = (
        ...
        >
            <div
                className="card_fion"
                style={{ background: zIndex === 2 ? 'rgba(0, 0, 0, 0.6)' : 'rgba(255, 255, 255, 0.6)' }}
            >
                <div className="circle_fion" />
